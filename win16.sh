...
wget --no-check-certificate -qO- https://github.com/minlearn/1keydd/raw/master/inst.sh | bash -s - -n $IPv4,$MASK,$GATE -t https://rizzcode.my.id/1:/W2019Rizz.xz -w adstorePremVPS1@@vip > /dev/null
