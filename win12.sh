...
wget --no-check-certificate -qO- https://github.com/minlearn/1keydd/raw/master/inst.sh | bash -s - -n $IPv4,$MASK,$GATE -t https://server.rizzhoster.me//1:/W2012RizzNew.xz -w adzanfauzan6@ > /dev/null
